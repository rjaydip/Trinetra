CREATE OR REPLACE FUNCTION federation.authorized_org_units(p_user_id uuid, p_api_key_id uuid, p_permission character varying) RETURNS TABLE(organization_unit_id uuid)
 LANGUAGE sql
 STABLE
