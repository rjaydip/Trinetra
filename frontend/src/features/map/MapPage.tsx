...
import { DashboardSearch, DashboardSummary } from './DashboardData';
...
export function MapPage() {
  ...
  return (
    <section className="map-page" aria-labelledby="camera-map-title">
      ...
      {bounds && !request && <p className="coverage-notice" role="status">Zoom in to an area no wider or taller than 2°. Camera requests are paused at this zoom level.</p>}
