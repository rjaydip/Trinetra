...
const importItemSchema = z.object({
  ...
  protocol: nullableString, vmsId: nullableString, streamReference: nullableString, credentialReference: nullableString,
  installationDate: nullableString, operationalStatus: nullableString, connectivityStatus: nullableString, maintenanceStatus: nullableString,
}).strict();
